...
<table cellspacing = "0" cellpadding = "0" border = "0" width = "95%">
	<tr>
		...
		<td width = "100%" bgcolor = "#05374A"><b class = "white">Datenbank:</b></td>
	...
	<tr>
		  <td width=160 align=right>
		  <font face="arial,helvetica" size=-1><span><b>
		Trinity 'auth' Datenbank:
		  </span></b></font>
		  </td>
		  <td align=left colspan = "2"><table border=0 cellspacing=0 cellpadding=0><tr><td><input name="sqldb"  style = "Width:150" taborder=5/ value="<? echo $MySQL_Set['DBREALM']; ?>"></td><td valign = "top">
